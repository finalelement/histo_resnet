import os
from deep_pnas_py_src.data import data_load, test_data
...
res_model = train_network(res_model, X, y, num_epoch=250, batch=1000)

print('Making Predictions and Saving file')

save_file_path = r'D:\Users\Vishwesh\PycharmProjects\Deep_PNAS\Model_Results_2019\seq_resnet.mat'
